package com.xml.xiaobinnode.api.feign.relationship;
 ...
 */
@FeignClient(name = "xiaobin-relationship", path = "/relationships")
public interface RelationshipFeignClient {
    ...
    /** 获取我的关系 */
    @GetMapping("/me")
    List<RelationshipVO> getMyRelationship(@RequestHeader("X-User-Id") Long userId);
